...
class UserServiceImplSpec extends Specification {
    ...
    private static UserRegisterRequest validRequest() {
        new UserRegisterRequest("Khan", "Huseynov", "khan@example.com", "0501234567", "Password123")
    }
    ...
    private static UserResponse successResponse() {
        new UserResponse(1L, "Khan", "Huseynov", "khan@example.com", "0501234567", true, Set.of("ROLE_USER"))
    }
}